...
//		Model model = new Model();
	...
	public @ResponseBody Hello value() throws Exception {
		// TODO Auto-generated method stub
	...
	public String upload(MultipartFile file) throws IOException {
		...
		OutputStream oStream = new FileOutputStream("/Users/apple/Desktop/testResourse/"+file.getOriginalFilename());
		@Cleanup InputStream iStream = file.getInputStream();
